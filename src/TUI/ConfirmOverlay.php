...
class ConfirmOverlay
{
    ...
    private function renderOverlay(
        ...
        // "[p] Always" persists to projects.yaml and outlives the session, so it
        // is labelled as the standing grant it is rather than as a third shade
        // of the same thing. The keys stay: a(llow), s(ession), p(roject), r(efuse).
        echo Terminal::BG_DARK . ' '
            . Terminal::GREEN . '[a] Allow once  '
            . Terminal::CYAN  . '[s] Session  '
            . Terminal::BLUE  . '[p] Always (project)  '
            . Terminal::RED   . '[r] Refuse'
            . ' ' . Terminal::RESET;
    }
