...
class FactExtractor
{
     ...
     *
     * A flat 24000 was the answer to that, and it is the right answer for a 32k
     * window. On a larger one it throws away most of a long session before
     * anyone looks at it — so it is now the floor of a share, and what a big
     * window buys is a longer memory of what was actually decided.
     */
