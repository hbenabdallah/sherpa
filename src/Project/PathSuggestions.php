 ...
 * `.env.example`. Either way the error used to say "not found" and nothing
 * else, so the next turn was another guess. Naming the real path turns that
 * turn into the right call.
 */
