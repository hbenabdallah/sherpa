...
class SystemPromptBuilder
{
     ...
     *
     * The ceiling was 8000, which capped the share at any window above ~160k and
     * was set when re-reading those characters cost real minutes. It buys back
     * the share for the large windows a machine with a graphics card can
     * actually hold; the floor is untouched, so a small window is unaffected.
     */
     ...
     *
     * SHERPA_CWD is the directory the user launched from, passed into the
     * container because nothing inside it can know. It is the single cheapest
     * signal available and it is already there.
     *
     * @return string[]
     */
