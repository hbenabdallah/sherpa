...
class OllamaPlatform implements PlatformInterface, EmbeddingBackend
{
    ...
    public function __construct(
        ...
        /**
         * Hard ceiling on one reply. ContextBudget plans the window around its
         * reservation and nothing used to make that true; wired from the same
         * parameter, in services.yaml, so the two cannot drift.
         */
