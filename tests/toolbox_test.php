...
#[AsTool(name: 'typed', description: 'Gives back what it was passed', permission: Permission::AUTO)]
final class TypedTool
{
    public function __invoke(
        #[Param('un entier')] int $count,
        #[Param('a boolean')] bool $flag = false,
...
// Seen in the benchmark: `file_grep`, called twice. The error names what exists.
check('and the error lists the tools that do exist', str_contains($result->content, 'Available tools: '), $result->content);
