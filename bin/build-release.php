...
//
//   php -d phar.readonly=0 bin/build-release.php <micro.sfx> <out-dir> <version>
//
// Run by `make release`, which fetches micro.sfx against a pinned checksum.
// Writes <out-dir>/sherpa-<version>-linux-x86_64, its .sha256 and
// THIRD-PARTY-NOTICES.md.

declare(strict_types=1);

[, $micro, $out, $version] = $argv + [null, null, null, null];
if ($micro === null || $out === null || $version === null || !is_file($micro)) {
    fwrite(STDERR, "Usage: php -d phar.readonly=0 bin/build-release.php <micro.sfx> <out-dir> <version>\n");
    exit(2);
}
...
$binary = "{$out}/sherpa-{$version}-linux-x86_64";
