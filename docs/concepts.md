...
When a provider refuses a request for a passing reason (HTTP 429 or 503, or
an "overloaded" error in the middle of the stream), Sherpa waits and asks
again, up to three times. It stops asking once part of the reply is on screen,
